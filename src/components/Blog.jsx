					...
					<div className='px-4 py-8 lg:w-1/3'>
						<div className='flex items-start h-full'>
							<div className='flex flex-col flex-shrink-0 w-12 leading-none text-center'>
								<span className='pb-2 mb-2 text-gray-500 border-b-2 border-gray-200'>Jul</span>
							...
							<div className='flex-grow pl-6'>
								...
								<h1 className='mb-3 text-xl font-medium text-gray-900 title-font'>The 400 Blows</h1>
					...
					<div className='px-4 py-8 lg:w-1/3'>
						<div className='flex items-start h-full'>
							...
							<div className='flex-grow pl-6'>
								...
								<h1 className='mb-3 text-xl font-medium text-gray-900 title-font'>Neptune</h1>
								<p className='mb-5 leading-relaxed'>
									Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing
									tousled waistcoat.
								</p>
								<a href='!' className='inline-flex items-center'>
									...
									/>
									<span className='flex flex-col flex-grow pl-3'>
										<span className='font-medium text-gray-900 title-font'>Henry Letham</span>
									</span>
								</a>
							</div>
						</div>
