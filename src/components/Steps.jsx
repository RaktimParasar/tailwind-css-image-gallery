			...
			<div className='container flex flex-wrap px-5 py-24 mx-auto'>
				<div className='flex flex-wrap w-full'>
					<div className='lg:w-2/5 md:w-1/2 md:pr-10 md:py-6'>
						...
						<div className='relative flex pb-12'>
							...
							<div className='flex-grow pl-4'>
								...
								<p className='leading-relaxed'>
									Vice migas literally kitsch +1 pok pok. Truffaut hot chicken slow-carb health
									goth, vape typewriter.
								</p>
							</div>
						</div>
						<div className='relative flex pb-12'>
							...
							<div className='flex-grow pl-4'>
								...
								<p className='leading-relaxed'>
									Coloring book nar whal glossier master cleanse umami. Salvia +1 master cleanse
									blog taiyaki.
								</p>
							</div>
						</div>
					...
					<img
						...
						src='https://images.pexels.com/photos/417271/pexels-photo-417271.jpeg?cs=srgb&dl=pexels-pixabay-417271.jpg&fm=jpg'
						alt='step'
					/>
				</div>
			</div>
