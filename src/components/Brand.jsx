			...
			<div className='container px-5 py-24 mx-auto'>
				<div className='flex flex-wrap mx-auto lg:w-4/5'>
					<img
						...
						src='https://images.pexels.com/photos/5985785/pexels-photo-5985785.jpeg?cs=srgb&dl=pexels-alexandr-podvalny-5985785.jpg&fm=jpg'
					/>
					<div className='w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0'>
						...
						<div className='flex mb-4'>
							...
							<span className='flex py-2 pl-3 ml-3 border-l-2 border-gray-200 space-x-2s'>
								<a href='!' className='text-gray-500 cursor-pointer hover:text-purple-800'>
									<svg
										fill='currentColor'
										stroke-linecap='round'
										stroke-linejoin='round'
						...
						<div className='flex'>
							...
							<button className='inline-flex items-center justify-center w-10 h-10 p-0 ml-4 text-gray-500 bg-gray-200 border-0 rounded-full cursor-pointer hover:text-red-800 hover:bg-red-200'>
								<svg
									fill='currentColor'
									stroke-linecap='round'
									stroke-linejoin='round'
